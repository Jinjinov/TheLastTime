...
namespace TheLastTime.Pages
{
    public sealed partial class Options : IDisposable
    {
        ...
        readonly SortedList<string, string> bootswatchThemeDict = new SortedList<string, string>()
        {
